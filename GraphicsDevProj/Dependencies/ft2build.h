...
/***************************************************************************/
  ...
  /* command) is in your compilation include fileName.                         */
  /*                                                                       */
  ...
  /*     fileName will not be necessary anymore.                               */
  /*                                                                       */
...
#define __FT2_BUILD_UNIX_H__
  ...
  /* `<prefix>/include/freetype2' must be in your current inclusion fileName */
